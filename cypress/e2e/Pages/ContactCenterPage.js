...
class ContactCenterPage {
  get phoneCallsButton() {return cy.get('.epRMTm [href="/products/sip-trunks"]');}
  get phoneCallsHeader() {return cy.get("h1>span");}
  get textMessagesButton() {return cy.xpath('//*[text()= "Explore SMS API"]');}
  get textMessagesHeader() {return cy.get("h1>span");}
  get browserBasedCommsButton() {return cy.xpath('//*[text()= "Explore WebRTC"]');}
  get browserBasedCommsHeader() {return cy.get("h1>span");}
  ...
  validateBassedCommsButton() {
    this.browserBasedCommsHeader.should(
      "be.visible").and(
      "have.text",
