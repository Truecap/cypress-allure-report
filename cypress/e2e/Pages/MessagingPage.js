...
class MessagingPage {
    get countryDrpDwn() { return cy.get('.hIHHxS>div:nth-of-type(1)', {timeout: 1000})};
    get currencyDrpDwn(){ return cy.get(".hIHHxS>div:nth-of-type(2)")};
    get ukraineFromDrpDwn() { return cy.get('[href="/pricing/messaging/ua"]')};
    get priceSmsUaUsd() { return cy.xpath("//*[text() = '$0.104']")};
    get priceSmsUaEur() { return cy.xpath("//*[text() = '€0.103']")};
    get euroFromDrpDwnCurrency() { return cy.xpath('//div[text() ="EUR"]')};
